...
const Home = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center">
      ...
      <div className="z-[1] w-full flex flex-col items-center overflow-hidden pt-[45%] md:pt-[7.5%]">
        <motion.div
          className="text-5xl md:text-8xl text-center mb-12 text-accent font-bold
        ...
        <div className="flex flex-col w-[90%] items-center justify-center">
          <div className=" text-4xl md:text-5xl font-bold bg-gradient-to-r ease-in-out via-purple-500 bg-clip-text text-purple-400 pb-4 md:pt-6">Time to go!</div>
          <Countdown
