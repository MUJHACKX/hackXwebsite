  ...
  <div className="flex flex-wrap justify-center md:justify-around">
    {chiefPatron && (
      <div className="flex flex-col " style={{ maxWidth: '300px' }}>
        ...
        <div className="flex justify-center">
          <a href={chiefPatron.personLinkedIn} target="_blank" rel="noopener noreferrer"><FaLinkedin  size="1.5em" className="ml-2 hover:text-blue-500" /></a>
          </div>
      </div>
    )}
    ...
    {patron && (
      <div className="flex flex-col " style={{ maxWidth: '300px' }}>
        ...
        <div className="flex justify-center">
          <a href={patron.personLinkedIn} target="_blank" rel="noopener noreferrer"><FaLinkedin  size="1.5em" className="ml-2  hover:text-blue-500" /></a>
          </div>
      </div>
    )}
  </div>
...
{coPatrons.length > 0 && (
    ...
    <div className="flex flex-wrap justify-center md:justify-around bg-primary">
      {coPatrons.map((coPatron, index) => (
        <div key={index} className="flex flex-col " style={{ maxWidth: '300px' }}>
          ...
          <div className="flex justify-center">
                  <a href={coPatron.personLinkedIn} target="_blank" rel="noopener noreferrer"><FaLinkedin  size="1.5em" className="ml-2 hover:text-blue-500" /></a>
                  </div>
        </div>
      ))}
    </div>
  ...
  <div key={index} className="flex flex-col " style={{ maxWidth: '300px' }}>
    ...
    <div className="flex justify-center">
      <a href={member.personLinkedIn} target="_blank" rel="noopener noreferrer"><FaLinkedin  size="1.5em" className="ml-2 hover:text-blue-500" /></a>
        ...
        <div key={index} className="flex flex-col" style={{ maxWidth: '300px' }}>
          <div className="relative overflow-hidden transition duration-300 transform rounded-lg hover:scale-105 hover:shadow-3xl hover:-translate-y-2 ">
            ...
            <div className="text-center py-4 hover:text-sky-400">
              <p className="mb-4 text-xl font-bold text-[#d1d3e3]">  {member.personName} 
                  </p>
                  <div className="flex justify-center">
                  <a href={member.personLinkedIn} target="_blank" rel="noopener noreferrer"><FaLinkedin  size="1.5em" className="ml-2 " /></a>
                  </div>
