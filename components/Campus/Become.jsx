...
export default function Become() {
  return(
<div className="w-full h-full flex justify-center p-36 " style={{backgroundColor: '#261B4B'}}>
<div className="flex flex-col  lg:flex-row justify-center border-solid border-2 h-full border-indigo-500/100 bg-slate-900 p-10 lg:p-10">
...
college life exciting.</p>
  ...
  <button className="border-2 bg-violet-600 text-white w-auto rounded-full p-1 lg:pl-10 lg:pr-7">Apply Now. Registration closes soon.</button>
  </div>
</div>
